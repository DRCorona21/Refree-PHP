...
<html lang="en">
    ...
    <body>
      ...
      <br>
              ...
              $stPub = $conexionPub->prepare('SELECT publicacion.*,autor FROM publicacion INNER JOIN autor ON publicacion.id_autor=autor.id_autor WHERE titulo LIKE :bus OR descripcion LIKE :bus OR editorial LIKE :bus OR edicion LIKE :bus OR autor.autor LIKE :bus');
              ...
              */
              ...
              for ($i=0; $i < count($rsPub); $i++) {
                //echo $rsPub[$i][0]."<br>";//id
                //echo $rsPub[$i][1]."<br>";//estado
                //echo $rsPub[$i][2]."<br>";//tipo
                //echo $rsPub[$i][3]."<br>";//url
                echo $rsPub[$i][4]." <br>";//des
                //echo $rsPub[$i][5]."<br>";//fecha
                //echo $rsPub[$i][6]."<br>";//email
                echo $rsPub[$i][7]." <br>";//editorial
                echo $rsPub[$i][8]." <br>";//edicion
                echo $rsPub[$i][9]." <br>";//titulo
                echo $rsPub[$i][12]." <br><br>";//autor
              }
